...
/*package*/ class Set_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_vbc55h_a() {
    ...
    editorCell.addEditorCell(createCollection_vbc55h_a0());
    editorCell.addEditorCell(createConstant_vbc55h_b0());
    editorCell.addEditorCell(createConstant_vbc55h_c0());
    editorCell.addEditorCell(createRefNode_vbc55h_d0());
    editorCell.addEditorCell(createConstant_vbc55h_e0());
    return editorCell;
  }
  private EditorCell createCollection_vbc55h_a0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_vbc55h_a0");
    editorCell.addEditorCell(createProperty_vbc55h_a0a());
    editorCell.addEditorCell(createConstant_vbc55h_b0a());
    editorCell.addEditorCell(createRefNodeList_vbc55h_c0a());
    return editorCell;
  }
  private EditorCell createProperty_vbc55h_a0a() {
  ...
  private EditorCell createConstant_vbc55h_b0a() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ": {");
    editorCell.setCellId("Constant_vbc55h_b0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_vbc55h_c0a() {
    AbstractCellListHandler handler = new Set_EditorBuilder_a.fieldsListHandler_vbc55h_c0a(myNode, "fields", getEditorContext());
  ...
  private static class fieldsListHandler_vbc55h_c0a extends RefNodeListHandler {
    ...
    public fieldsListHandler_vbc55h_c0a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(fieldsListHandler_vbc55h_c0a.this.getNode(), MetaAdapterFactory.getContainmentLink(0xa7f45b2b89264555L, 0x82d3927859451525L, 0xdff9927af035b1aL, 0xdff9927af035b55L, "fields")));
      try {
  ...
  private EditorCell createConstant_vbc55h_b0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
  ...
  private EditorCell createRefNode_vbc55h_d0() {
    SingleRoleCellProvider provider = new Set_EditorBuilder_a.domainDefinitionSingleRoleHandler_vbc55h_d0(myNode, MetaAdapterFactory.getContainmentLink(0xa7f45b2b89264555L, 0x82d3927859451525L, 0xdff9927af035b1aL, 0x59a318f513b3ec25L, "domainDefinition"), getEditorContext());
    return provider.createCell();
  }
  private static class domainDefinitionSingleRoleHandler_vbc55h_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public domainDefinitionSingleRoleHandler_vbc55h_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
